...
<script type="text/javascript" src="${staticPath }/static/easyui/jquery.easyui.patch.js" charset="utf-8"></script>
...
<%-- [官方json] --%>
<script type="text/javascript" src="${staticPath }/static/json2.js" charset="utf-8"></script>
<%-- [扩展样式] --%>
