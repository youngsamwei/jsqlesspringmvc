...
<title>数据库应用软件测试评价系统</title>
<script type="text/javascript">
    var currentTermid = ${currentTerm.termid };
    var currentTermname = "${currentTerm.termname }";
    var currentSchoolyear = "${currentTerm.schoolYearName }";
    var index_tabs;
    var indexTabsMenu;
    var indexMenuZTree;
    $(function() {
...
<body>
    ...
    <div id="index_layout">
        <div data-options="region:'north',border:false" style="overflow: hidden;">
            <div>
                <span style="float: right; padding-right: 20px; margin-top: 15px; color: #333">
                    <i class="fi-torso"></i>
                    <b><shiro:principal></shiro:principal>&nbsp;&nbsp;<shiro:principal property="name"/></b>
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2018 power by <a href="http://cise.sdust.edu.cn" target="_blank">山东科技大学计算机学院</a></div>
    </div>
    <div id="tabsMenu">
