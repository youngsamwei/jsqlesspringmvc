...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="questionAddForm" style="height:100%" method="post">
            <table style="height:100%" class="grid">
                <tr>
                    <td width="60">实验名称</td>
                    <td><input name="examid" type="hidden"  value="${examination.examid}">
                    <input name="quesname" type="text" placeholder="题目名称" class="easyui-validatebox" style="width:100%" data-options="width:300,height:29, required:true" value="">
                    </td>
                </tr>

                <tr  style="height:90%">
                    <td>题目内容</td>
                    <td > <textarea id="quescontent" name="quescontent" style="height:100%" >请在此增加题目内容</textarea>                    </td>
                </tr>
