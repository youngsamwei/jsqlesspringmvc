...
public class SysLogAspect {
    ...
    private static int maxContentSize =  1024;
        ...
        if (isWriteLog(strMethodName)) {
            try {
                ...
                if (null != collection) {
                    ...
                    /* 超过 maxContentSize的将截取*/
                    sysLog.setOptContent(strMessage.substring(0, strMessage.length() < maxContentSize ? strMessage.length() : maxContentSize));
